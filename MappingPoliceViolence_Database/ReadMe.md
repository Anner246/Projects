...
The minimum requirement was 7 tables with 15 rows of sample data per table. Nowi had been doing really well in the course up until then and i wanted to really challenge myself. I wanted something that I could use to show future employers that I could handle real world applications and workloads. I made the decision to include all the data in the file, 14,000+ rows.
